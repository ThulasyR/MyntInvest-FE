...
class Inv_Signup extends React.Component {
  constructor() {
    super();
    this.state = {
      input: {},
  ...
  render() {
    return (
      <body className="bg-white">
        <nav
          className="bg-White navbar-dark navbar"
          style={{ paddingLeft: 500, paddingTop: 50 }}
        >
                ...
                <div className="reveal-from-bottom" data-reveal-delay="600">
                  <ButtonGroup className="align-item-center">
                    ...
                    <Button
                      tag="a"
                      color="primary"
                      style={{ backgroundColor: "white", color: "#2ECC71" }}
                      wideMobile
                      href=""
                    >
                      Better
                  ...
                  <ButtonGroup>
                    <Button
                      tag="a"
                      color="primary"
                      style={{ backgroundColor: "#58C479", color: "white" }}
                      wideMobile
                      href=""
                    >
                      Microsoft
            ...
            >
              ...
              <div className="col-12">
                <div className="d-grid gap-2 mx-auto">
                  <button
                    type="button"
                    className="btn btn-warning btn-sm w-100g"
                    wideMobile
                  ...
                  <button
                    type="button"
                    className="btn btn-light btn-sm w-100g"
                    id="googleintrgration"
                    wideMobile
                  >
                    Sign up With Google
                  </button>
