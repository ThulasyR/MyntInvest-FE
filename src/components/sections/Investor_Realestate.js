        ...
        <div className={innerClasses}>
          ...
          <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm" style={{color:"black"}}>
                    Global Real Estate Investments Vetted By Experienced Professionals.
                  </p>
...
Investor_Realestate.propTypes = propTypes;
Investor_Realestate.defaultProps = defaultProps;

export default Investor_Realestate;