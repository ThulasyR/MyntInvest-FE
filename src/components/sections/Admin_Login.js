...
class Admin_Login extends React.Component { 
    ...
    constructor() {
        ...
        this.validateAdminLogin = this.validateAdminLogin.bind(this);
      }
      ...
      handleAdminChange(event) {
        ...
        this.setState({
          EMAIL :this.state.input.Adminemail,
          PASSWORD : this.state.input.Adminpassword,
        });
      }
    ...
    validateAdminLogin(event) {
        ...
        DataService.passData("/adminlogin",data)
        .then(response => {  
            window.showLoader(); 
          this.setState({ 
            EMAIL :response.data.Adminemail,
            PASSWORD : response.data.Adminpassword, 
          }); 
        ...
        .catch(e => {
          ...
          window.location.href = "/Admin_Login";//to redirect to normal links
        });
    }
...
render() {
    return( 
      ...
      <h3></h3>
            ...
            <form name="Adminform" id="Adminform" method="POST" className="row m-5 g-3"  > 
            
                
                <div className="col-12">
                <h3 align="Center">Welcome Back!</h3> 

                  <label for="Adminemail" className="form-label">E-mail</label>
                  <input type="text" className="form-control"  id="Adminemail" name="Adminemail" 
                    value={this.state.input.Adminemail}
                ...
                <div className="col-12"> 
                  ...
                  <input type="password" className="form-control"  id="Adminpassword" name="Adminpassword" 
                    value={this.state.input.Adminpassword}
                    onChange={this.handleAdminChange}
                ...
                <div className="col-12">
                  <div className="d-grid gap-2 mx-auto">
                      <button type="button" className="btn btn-success btn-sm w-100g"  wideMobile onClick={this.validateAdminLogin}>Sign Up</button>
                  </div>
                </div> 
                </form> 
            </div>
