...
class Investors_Details extends React.Component {
  constructor() {
    ...
    this.validateMobilePaymentGateway =
      this.validateMobilePaymentGateway.bind(this);
  }
    ...
    if (this.validateInvestorInfo()) {
      if (!window.isEmpty(sessionStorage.getItem("sessEmail"))) {
        ...
        if (window.isEmpty($("#investorKYCid").val())) {
          ...
          DataService.update(
            "/investordetails/" + $("#investorKYCid").val(),
            invdata
          )
            .then((response) => {
              window.showLoader();
                    ...
                    <ul className="navbar-nav" style={{ fontSize: 13 }}>
                      <li className="nav-item btn-warning">
                        <NavLink
                          ...
                          // }}
                          className="nav-link arrow-right para font14 text-white"
                          id="KycToDashboard"
                        >
                          &nbsp;Back to Dashboard
                        </NavLink> 
...
<br/>
  <p className="font16 text-danger b" id="kycbackerrormessage"></p>
                <div className="container">
                  <div className="row" style={{ height: "auto" }}>
                            ...
                            <div class="  px-0 pt-4 pb-0 mb-3 p-5">
                              <form id="msform">
                                ...
                                <fieldset>
                                    ...
                                    <div class="container mt-3 text-start">
                                      ...
                                      <div class="input-group mb-3 input-group-sm">
                                        ...
                                        <input
                                          style={{ width: "62%" }}
                                          type="text"
                                          class="form-control mobilenumberval"
                                          id="mobilenumber"
                                          name="mobilenumber"
                                  ...
                                  {/* <input
                                    type="button"
                                    class="next btn btn-dark btn-sm "
                                    value="Next" 
                                  /> */}
                                  &nbsp;&nbsp;
                                  <input
                                ...
                                <fieldset>
                                  <div class="form-card">
                                    ...
                                    <div class="container mt-3 mb-3 text-start">
                                      ...
                                      <input
                                        ...
                                        id="mobileOTPNo"
                                        name="mobileOTPNo"
                                        placeholder="Enter Mobile OTP Number"
                                        maxlength="6"
                                      />
                                      <div
                                        className="text-danger errors"
                                  ...
                                  <input
                                    type="button"
                                    name="previous"
                                    class="previous  btn btn-secondary btn-sm"
                                    value="Previous"
                                  />
                                  &nbsp;&nbsp;{" "}
                                  <input
                                ...
                                {/* <fieldset>
                                  <div class="form-card">
                                    <div class="row">
                                      ...
                                      <div class="container mt-3 mb-3 text-start" style={{display:"none"}}>
                                        <h1>Thank your now submit the form!
                                        <label
                                          style={{ textAlign: "left" }}
                                          className="para text-start b"
                                          for="bankaccnumber"
