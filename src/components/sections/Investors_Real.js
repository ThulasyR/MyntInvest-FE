    ...
    >
      <div className="container">
        <div className={innerClasses} />
         ...
         <h2 align="Center">Why Invest In <span style={{color:"#2ECC71"}}>Real Estate?</span></h2>
...
Investors_Real.propTypes = propTypes;
Investors_Real.defaultProps = defaultProps;

export default Investors_Real;